...
G = [(13, 1, 2), (18, 1, 3), (17, 1, 4), (14, 1, 5), (22, 1, 6),
     (26, 2, 3), (22, 2, 5), (3, 3, 4), (19, 4, 6)]

G_sorted = sorted(G, key=sort) # отсортированный список ребер графа по возрастанию весов
U = set()   # список соединенных вершин
D = {}      # словарь списка изолированных групп вершин
Os = []      # список ребер остова
    ...
    if r[1] not in U or r[2] not in U:  # проверка для исключения циклов в остове
        if r[1] not in U and r[2] not in U: # если обе вершины не соединены, то
            ...
            if not D.get(r[1]):             # если в словаре нет первой вершины, то
                ...
                D[r[2]] = D[r[1]]           # получаем словарь несвязанных друг с другом вершин

        Os.append(r)             # добавляем ребро в остов
        U.add(r[1])             # добавляем вершины в множество U
        U.add(r[2])

for r in G_sorted:    # проходим по ребрам второй раз и объединяем разрозненные группы вершин
